...
namespace FinalProject.Models
{
    ...
    {
        // RestClient is a Client used to translate RestRequests into HTTP requests and process response results
        ...
        /// <summary> Return a new quote pulled from RapidAPI Motivational Quotes </summary>
